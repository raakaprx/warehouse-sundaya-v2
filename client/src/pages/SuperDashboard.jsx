...
import { 
    MapPin, TrendingUp, AlertTriangle, Package, 
...
const SuperDashboard = () => {
    ...
    const [exporting, setExporting] = useState(false); // ← Tambah state ini
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            link.href = url;
            link.setAttribute('download', `laporan_stock_${Date.now()}.pdf`);
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <div className="flex items-center gap-2 text-gray-500">
                        ...
                        <p className="text-sm font-medium">
                            Real-time Global Warehouse Analytics • {new Date().toLocaleDateString('id-ID', { 
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        disabled={exporting}
                        className="flex items-center gap-2 px-6 py-2.5 bg-sundaya-primary text-white rounded-xl font-bold text-sm hover:bg-sundaya-dark transition-all shadow-lg shadow-sundaya-primary/20 disabled:opacity-50"
                    >
                        <FileText size={18} />
                        {exporting ? '⏳ Exporting...' : 'Export Stock Report (PDF)'}
                    </button>
                </div>
            </div>
